...
class CRNN:
    ...
    def forward_pass(self):
        ...
        conv2_1 = tf.nn.elu(layers.batch_normalization(conv2_1, training=self.phase_train))
        ...
        conv2_2 = tf.nn.elu(layers.batch_normalization(conv2_2, training=self.phase_train))
        ...
        conv2_3 = tf.nn.elu(layers.batch_normalization(conv2_3, training=self.phase_train))
        ...
        conv2_4 = tf.nn.elu(layers.batch_normalization(conv2_4, training=self.phase_train))
        ...
        logits = tf.layers.dense(dropout_5, len(tags))
        return logits
